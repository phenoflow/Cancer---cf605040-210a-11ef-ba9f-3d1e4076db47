...
steps:
  ...
  cancer-descended---primary:
    run: cancer-descended---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  genitourinary-cancer---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: cancer-descended---primary/output
  ...
  cancer-lipstick---primary:
    run: cancer-lipstick---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  primary-cancer---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: cancer-lipstick---primary/output
  ...
  cancer-auditory---primary:
    run: cancer-auditory---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  cancer-specified---primary:
    run: cancer-specified---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: cancer-auditory---primary/output
  pancreatic-cancer---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: cancer-specified---primary/output
  ...
  cancer-2ndry---primary:
    run: cancer-2ndry---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  cancer-pericardium---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: cancer-2ndry---primary/output
  ...
  cancer-excluding---primary:
    run: cancer-excluding---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  unknown-cancer---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: cancer-excluding---primary/output
  ...
  tracheobronchial-cancer---primary:
    run: tracheobronchial-cancer---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  endocervical-cancer---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: tracheobronchial-cancer---primary/output
  ...
  cancer-seminoma---primary:
    run: cancer-seminoma---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  cancer-sezary---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: cancer-seminoma---primary/output
  ...
  internal-cancer---primary:
    run: internal-cancer---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  cancer-orifice---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: internal-cancer---primary/output
  cancer-inferior---primary:
    run: cancer-inferior---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  cancer-isthmu---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: cancer-inferior---primary/output
